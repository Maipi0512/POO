...
public class PanelProductos extends JPanel {
    ...
    public void cargarDatos() {
        ...
        for (Rubro r : sistema.getRubros()) rubro.addItem(r);

        proveedor.removeAllItems();
        for (Proveedor p : sistema.getProveedores()) proveedor.addItem(p);
    ...
    private void registrarProducto() {
        try {
            ...
            Producto producto = new Producto(
                    ...
                    (TipoIVA) tipoIVA.getSelectedItem(),
                    (Rubro) rubro.getSelectedItem()
            );
    ...
    private void agregarPrecioExistente() {
        try {
            ...
            Producto existente = sistema.buscarProductoPorCodigo(codigo.getText().trim());
            if (existente == null) {
            ...
            sistema.agregarPrecioAcordado(codigo.getText().trim(), prov.getCuit(), valor);
    ...
    private void mostrarCompulsa() {
        ...
        for (PrecioAcordado pa : sistema.consultarCompulsaPrecios(cod)) {
            sb.append(pa.getProveedor().getRazonSocial())
              ...
              .append(pa.estaVigente() ? " (vigente)" : " (historico)")
              .append("\n");
        }
